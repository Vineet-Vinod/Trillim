...
class Server:
    ...
    def __init__(self, *components: Component, allow_llm_hot_swap: bool = False):
        ...
        self._allow_llm_hot_swap = allow_llm_hot_swap
        self._app: FastAPI | None = None

    @property
    def allow_llm_hot_swap(self) -> bool:
        """Return whether LLM hot swap routes are allowed."""
        return self._allow_llm_hot_swap
